...
public class TransaksiPenjualan extends javax.swing.JFrame {
    ...
    PurchaseTransaction transaksi = new PurchaseTransaction(ID, Tanggal, Total, items);

    // Simpan transaksi ke database
    boolean success = new TransactionService().simpanTransaksiPenjualan(transaksi);
        if (success) {
    ...
    private void initComponents() {
        ...
        setTitle("Transaksi Penjualan - POS");
